...
public class Activator extends AbstractUIPlugin {
	// The plug-in ID
	public static final String PLUGIN_ID = "no.hvl.multecore.editor";
	...
	public void start(BundleContext context) throws Exception {
		...
		viewpoints.addAll(ViewpointRegistry.getInstance().registerFromPlugin(PLUGIN_ID + "/description/multEcore.odesign"));
